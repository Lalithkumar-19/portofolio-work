      ...
      <div id="home" className="flex gap-10 flex-col-reverse lg:flex-row place-items-center justify-between p-10 md:p-20 bg-gradient-to-r from-blue-50 to-white">
        ...
        <div ref={textRef} className="text-center md:text-left max-w-[700px] mt-10 md:mt-0 flex flex-col place-items-center">
          ...
          <div className="w-full flex place-content-center lg:place-content-start">
            {/* <a href="#about" className="inline-block mt-6 bg-blue-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">Discover Now</a> */}
         
          <button class="bg-blue-400 mt-5 cursor-pointer text-white border border-blue-400 border-b-4 font-medium overflow-hidden relative px-4 py-2 rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group">
